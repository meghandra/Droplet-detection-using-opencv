# -*- coding: utf-8 -*-
"""yolov8 drop opencv.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17pEM431oO-y9n6MXATgyXaXlGyHKXcyU
...
# Replace 'your_model.pt' with the path to your actual model file
model = torch.load(f'{HOME}/yolov8n.pt')

# You can optionally provide additional arguments to customize the visualization
dot = make_dot(model, params=dict(show_attrs=False))

# Display the visualization using a library like graphviz
dot.render('model_architecture', format='png')  # Change format as desired (svg, pdf, etc.)
...
rf = Roboflow(api_key="goFsfjtDG86lBRZaIrxx")
project = rf.workspace("test1-slid9").project("waam-0o9pr")
